...
public class AllNativesReport extends JDialog implements ActionListener{
    ...
    public AllNativesReport(Frame owner, String title, boolean modal) {
        ...
        progressBar = new  ProgressBarPanel("...Loading Natives Report");
    ...
    public JasperPrint getReport(){
        ...
        JasperPrint jp = null ;
        String reportURL = "Report/AllNatives.jasper";
