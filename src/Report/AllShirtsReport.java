...
public class AllShirtsReport extends JDialog implements ActionListener{
    ...
    public AllShirtsReport(Frame owner, String title, boolean modal) {
        ...
        progressBar = new  ProgressBarPanel("...Loading Shirts Report");
    ...
    public JasperPrint getReport(){
        ...
        JasperPrint jp = null ;
        String reportURL = "Report/AllShirts.jasper";
