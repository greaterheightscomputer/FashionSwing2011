...
public class AllSuitsReport extends JDialog implements ActionListener{
    ...
    public AllSuitsReport(Frame owner, String title, boolean modal) {
        ...
        progressBar = new  ProgressBarPanel("...Loading Jacket/Suits Report");
    ...
    public JasperPrint getReport(){
        ...
        JasperPrint jp = null ;
        String reportURL = "Report/AllSuits.jasper";
